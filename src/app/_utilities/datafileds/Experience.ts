...
export const ExperienceData: ExperienceType[] = [
  ...
  },
  {
    ...
    keypoint: [
      ...
      "Developed a dynamic form builder using React.js and Tailwind CSS.",
      "Developed a dynamic diagram builder using React.js and Tailwind CSS. like sequence diagram ,class diagram,Er diagram and many others",
    ],
    skills: [
      "React",
      "Express",
  ...
  },
  {
    ...
    keypoint: [
      ...
      "Integrated user authentication and authorization features using NextAuth.js within the Next.js application, providing secure login/ logout functionalities and managing user sessions effectively.",
      "Conducted unit testing using Jest for frontend components and integration testing for Next.js API routes, ensuring code reliability and functionality across the application.",
